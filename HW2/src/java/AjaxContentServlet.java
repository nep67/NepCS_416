...
@WebServlet(name = "AjaxContentServlet", urlPatterns = {"/AjaxContentServlet"})
public class AjaxContentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (sessionCount != null){
                out.println("I have voted " + sessionCount + " times");
            ...
            if (contextCount != null){
                ...
                out.println("All users since the server started have voted " + contextCount + " times");
            }
            out.close();
        }
    }
